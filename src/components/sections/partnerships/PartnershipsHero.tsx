    ...
    <section className="relative py-20 640:py-28 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white overflow-hidden">
      ...
      <div className="app-container relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            We collaborate with world-class OEM manufacturers to deliver
            cutting-edge technology, reliable equipment, and comprehensive
            support across oil & gas, power, construction, and
          ...
          >
            <AppCtaButton
              ...
              type="signup"
            >
              <span className="h-full y-center">View Our Partners</span>
            </AppCtaButton>
          ...
          >
            <div className="text-center">
              <div className="text-2xl 640:text-3xl font-bold text-blue-400 mb-2">
                6+
              </div>
