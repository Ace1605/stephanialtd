...
import pos from '/public/assets/products/pos-wide.png';
  ...
  return (
    <>
      <ProductsHero
        ...
        image={phone}
        title={'Create Delightful, Inperson '}
        lastWord='Payment Experiences'
        description={
          'Enabling African Teams to Create Unique, Enjoyable Face-to-Face Payment Experiences that Foster Customer Loyalty.'
        }
